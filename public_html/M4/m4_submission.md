...
<tr><td> <em>Generated: </em> 2/20/2022 10:57:42 PM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-002-S22/init-db-setup/grade/yre2" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98475508/154884028-79e2d3db-7618-41ea-a1e1-1f35f6a5969c.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>PHP file<br></p>
</td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98475508/154885688-22e3acef-8681-48c5-86d8-ab59f5d981e2.png"/></td></tr>
...
<tr><td> <em>Response:</em> <p>I learned how SQL works and how it works within vscode, I was<br>able to learn more about GitHub and Heroku being able to practice and<br>get more familiar.   I got to read about queries and join<br>as well as different data types.  <br></p><br></td></tr>
...
<tr><td> <em>Response:</em> <p>I had difficulty getting the PHP file to work on Heroku, I find<br>out that in the repo it was blank then I added it multiple<br>times in git bash and manually deployed the ProjectSetup branch.  Also with<br>the MySql table I was getting access denied, and was having trouble connecting<br>the MySQL extension, and then realized that were no tables shown on purpose.<br>    <br></p><br></td></tr>
<tr><td> <em>Sub-Task 3: </em> Add the pull request link (ProjectSetup to Dev)</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/yaheyaelsaid20/IT202_01/pull/6">https://github.com/yaheyaelsaid20/IT202_01/pull/6</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://yre2-dev.herokuapp.com/Project/sql/init_db.php">https://yre2-dev.herokuapp.com/Project/sql/init_db.php</a> </td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-002-S22/init-db-setup/grade/yre2" target="_blank">Grading</a></td></tr></table>